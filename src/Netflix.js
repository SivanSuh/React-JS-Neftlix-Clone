...
function Netflix() {
    ...
    return (
        ...
        <div className="container">
            ...
            <main className="main">
                <div>
                    <h1 className="titleNetflix">Sınırsız film, dizi ve çok daha fazlası.</h1>
                </div>
                <div>
                    <p className="p-title">İstediğiniz yerde izleyin. İstediğiniz zaman iptal edin.</p>
                </div>
                <div>
                    <p className="p-title">İzlemeye hazır mısınız? Üyelik oluşturmak veya üyeliğinize erişmek için e‑posta adresinizi girin.</p>
                </div>
